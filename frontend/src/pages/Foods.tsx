...
import {
  ...
  IconButton, InputAdornment, Tooltip, Box, Skeleton, Divider
} from '@mui/material';
    ...
    <Container sx={{ py: 4 }}>
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
        ...
        <Stack direction="row" spacing={1}>
          ...
          <RoleGuard allow={['waiter']}>
            <Button variant="contained" startIcon={<AddIcon />} onClick={openCreate}>Add Food</Button>
          </RoleGuard>
        </Stack>
      </Stack>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent sx={{ display:'grid', gap:2, mt:1 }}>
          ...
          <Divider />
          <Typography variant="caption" color="text.secondary">Make sure the name is unique.</Typography>
        </DialogContent>
